...
class BertSelfAttention(nn.Module):
    ...
    def forward(self, q, k, v, attention_mask, head_mask=None, output_attentions=False):
        ...
        if attention_mask is not None:
            ...
            rest_shape = attention_mask.shape[1:]
            attention_mask = attention_mask.unsqueeze(1).repeat(1, n_head, 1, 1).view(sz_b * n_head, *rest_shape)
...
class BertLayer(nn.Module):
    ...
    def forward(self, hidden_states, non_pad_mask=None, attention_mask=None, 
        encoder_hidden_states=None, attend_to_enc_output_mask=None,
        ...
        if self.attend_to_enc_output is not None:
            ...
            attention_outputs = self.attend_to_enc_output(
                attention_output, encoder_hidden_states, encoder_hidden_states, 
